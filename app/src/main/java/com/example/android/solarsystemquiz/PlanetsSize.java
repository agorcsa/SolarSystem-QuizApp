...
public class PlanetsSize extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_planets_size);
    }

    public void startDiscoveryAndExploration(View view) {
        startActivityWithParams(DiscoveryAndExploration.class);
    }
    ...
    private void startActivityWithParams(Class<?> cls) {
        RadioGroup question = (RadioGroup) findViewById(R.id.secondQuestion);
